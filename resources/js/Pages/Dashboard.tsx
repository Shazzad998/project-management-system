                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        {pendingProjects.map((pendingProject) => (
                                            <TableRow key={pendingProject.id}>
                                                <TableCell>
                                                    {pendingProject.id}
                                                </TableCell>
                                                <TableCell>
                        ...
                        <CardContent>
                            <div className="rounded-md border">
                                <Table>
                                    ...
                                    <TableBody>
                                        {overdueProjects.map((overdueProject) => (
                                            <TableRow key={overdueProject.id}>
                                                <TableCell>
                                                    {overdueProject.id}
                                                </TableCell>
                                                <TableCell>
                                        ...
                                        {!overdueProjects.length && <TableRow><TableCell colSpan={4}>No data found</TableCell></TableRow>} 
                                    </TableBody>
                                </Table>
                            </div>
                        </CardContent>
